...
def keys_to_output(keys):
	...
	#uncomment the following to get back to original mapping		
...
def image_processing(image):
	...
	vertices = np.array([[70,400],[70,260],[600,260],[600,400],
						 ], np.int32)
...
def main(file_name, starting_value):
	...
	with mss.mss() as sct:
		...
		while(True):
			...
			cv2.moveWindow('screenshots',700,500)
			#resize the image
